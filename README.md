Run `npm install` to install necessary modules in the main project folder.
Run `npm install` to install necessary modules in the client project folder.


Run `node server.js` in the main project folder.
Run `npm start` in the client project folder.
Run `npm test` in the client project folder to test the App.
